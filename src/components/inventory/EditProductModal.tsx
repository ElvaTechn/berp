...
export default function EditProductModal({ product, open, onOpenChange, onSuccess }: EditProductModalProps) {
  const handleClose = () => {
    onOpenChange(false);
  };
        ...
        <NeuDialogHeader>
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl neu-surface neu-convex-md flex items-center justify-center">
              <Edit2 className="w-6 h-6 text-[var(--neu-accent)]" />
            </div>
            <div>
              <NeuDialogTitle>Editar Produto</NeuDialogTitle>
              <NeuDialogDescription>{product.name}</NeuDialogDescription>
            </div>
          </div>
        </NeuDialogHeader>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="neu-text-label mb-1.5 block flex items-center gap-1">
                <Tag className="w-4 h-4 text-[var(--neu-success)]" />
                Preço Venda (MT) *
              </label>
              ...
              {errors.price && (
                <p className="neu-text-caption text-[var(--neu-error)] mt-1">
                  {errors.price}
                </p>
              )}
            </div>
            ...
            <div>
              <label className="neu-text-label mb-1.5 block flex items-center gap-1">
                <Tag className="w-4 h-4 text-[var(--neu-warning)]" />
                Preço Custo (MT)
              </label>
              <div className="relative">
